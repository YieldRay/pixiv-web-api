...
export const myProfileUpdate = (data: FormData) => requestJSONAPI(`/ajax/my_profile/update`, undefined, data);

export const notifaction = (query?: Query<{ darkTheme: 0 | 1 }>) => requestJSONAPI(`/ajax/notification`, query);
