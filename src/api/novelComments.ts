...
export const novelsCommentsRoots = (query: Query<{ novel_id: number; limit: number; offset: number }>) =>
    requestJSONAPI(`/ajax/novels/comments/roots`, query);

export const novelsCommentsReplies = (query: { comment_id: number; page: number }) =>
