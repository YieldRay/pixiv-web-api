...
export const novelsLike = (data: { novel_id: string }) => requestJSONAPI(`/ajax/novels/like`, undefined, data);

export const novelRpcMarker = (data: { mode: "save"; i_id: string; u_id: string; page: string }) =>
